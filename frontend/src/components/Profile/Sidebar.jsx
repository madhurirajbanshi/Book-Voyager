    ...
    <aside className="bg-white p-8 rounded-xl border-r border-gray-300 w-full h-screen flex flex-col items-center">
      {loading ? (
        ...
        <div className="text-center">
          <img
            src="https://th.bing.com/th/id/OIP.65cr4DZsNGAvYWUr6Rg5qQHaHa?rs=1&pid=ImgDetMain"
            alt="Profile Avatar"
...
const SidebarLink = ({ to, label }) => (
  <Link
    to={to}
    className="block p-2 text-center bg-pink-100 hover:bg-pink-200 transition-all rounded-lg text-gray-700 font-medium"
  >
    {label}
  </Link>
);
